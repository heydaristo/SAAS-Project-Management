<aside class="navbar navbar-vertical navbar-expand-lg">
    <div class="container-fluid sidebar-divider">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('admin.dashboard') }}" class="text-center" style="text-decoration: none;">
                <img src="{{ asset('images/polalogo.png') }}" alt="pola logo"
                    class="navbar-brand-image d-none-navbar-horizontal" >
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item  {{ request()->routeIs('admin.subscription.show') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('admin.subscription.show') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item {{ request()->routeIs('admin.plan.show') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('admin.plan.show') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item {{ request()->routeIs('admin.transaction.show') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('admin.transaction.show') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cash"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
