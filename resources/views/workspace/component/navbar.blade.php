            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm">
                        ...
                        @if (Auth::user()->photo_profile == null)
                            <img src="{{ asset('img/default.png') }}" alt="Avatar" class="avatar-img rounded-circle">
                        @else
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="#" class="dropdown-item" data-bs-toggle="modal"
                        data-bs-target="#modalStatus">Status</a>
                    ...
                    @if (Auth::user()->id_role == 3)
                        <a href="{{ route('workspace.subscriptions.upgradeshow') }}" class="dropdown-item"
                            style="background-color: #003cbe; color:white; width: 100px; height:35px;">Upgrade to
                            Premium</a>
                    @endif
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('workspace.dashboard.storeStatus', ['id' => Auth()->user()->id]) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="status" id="statusActive"
                            value="Active" {{ $userStatus == 'Active' ? 'checked' : '' }}>
                    ...
                    <hr>
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="radio" name="status" id="statusBusy"
                            value="Busy" {{ $userStatus == 'Busy' ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="statusOffline"
                            value="Offline" {{ $userStatus == 'Offline' ? 'checked' : '' }}>
