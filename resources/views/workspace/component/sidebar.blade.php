    ...
    <div class="container-fluid sidebar-divider">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item  {{ request()->routeIs('workspace.quotation') ? 'active' : '' }} mt-5">
                ...
                <li class="nav-item  {{ request()->routeIs('workspace.contract') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('workspace.contract') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-align-box-center-stretch" width="24"
                ...
                <li class="nav-item  {{ request()->routeIs('workspace.invoice') ? 'active' : '' }}">
                    ...
                    <a class="nav-link" href="{{ route('workspace.invoice') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-receipt-dollar" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path
                ...
                <li class="nav-item {{ request()->routeIs('workspace.transaction.show') ? 'active' : '' }} mt-5">
                    <a class="nav-link" href="{{ route('workspace.transaction.show') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
